...
# Install Android SDK
RUN wget https://dl.google.com/android/android-sdk_r21.1.2-linux.tgz
RUN tar -xvzf android-sdk_r21.1.2-linux.tgz
RUN mv android-sdk-linux /usr/local/android-sdk
RUN rm android-sdk_r21.1.2-linux.tgz

ENV ANDROID_COMPONENTS platform-tools,android-21,android-23,android-24,build-tools-23.0.2,build-tools-21.1.2,build-tools-24.0.0
